...
if (empty($municipios)) {
    // Consulta quando o parâmetro "municipio" está vazio
    $query = "SELECT * FROM cartorios";
} else {
    // Consulta quando o parâmetro "municipio" não está vazio

    $query = "SELECT * FROM cartorios WHERE municipio IN ($municipioString)";
}
